...
type NotificationsStatusDonutProps = {
  total: number;
  slices: NotificationSummarySlice[];
};
...
export function NotificationsStatusDonut({
  total,
  slices,
}: NotificationsStatusDonutProps) {
  let offset = 0;
    ...
    <div className="flex flex-col items-center gap-5 sm:flex-row sm:items-center sm:gap-6">
      <div className="relative size-36 shrink-0">
        <svg viewBox="0 0 140 140" className="size-full -rotate-90" role="img">
          <title>Notification status distribution</title>
          <circle
            cx="70"
            cy="70"
            r={RADIUS}
