...
import type { ReportTypeSlice } from '../types/reports.types';

type ReportsTypeDonutProps = {
  total: number;
  slices: ReportTypeSlice[];
};
...
export function ReportsTypeDonut({ total, slices }: ReportsTypeDonutProps) {
  let offset = 0;
