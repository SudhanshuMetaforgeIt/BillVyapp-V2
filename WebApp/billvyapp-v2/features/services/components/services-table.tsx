...
import { useToggleServiceStatus } from '../hooks/use-service-mutations';
import type { PaginationMeta, ServiceListRow } from '../types/services.types';
          ...
          <tbody>
            {rows.map((row) => (
              ...
              >
                ...
                <td className="px-4 py-3.5 text-text">{row.categoryLabel}</td>
